...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 18 Mar 2025 pada 15.06
...
--
ALTER TABLE `tbpegawai`
  ADD CONSTRAINT `fk_gol` FOREIGN KEY (`gol`) REFERENCES `tbgaji` (`gol`) ON DELETE SET NULL ON UPDATE CASCADE;
COMMIT;
